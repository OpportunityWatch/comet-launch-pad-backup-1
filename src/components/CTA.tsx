...
const CTA = () => {
  return (
    <section className="py-20 relative overflow-hidden bg-gradient-to-b from-comet-darkblue to-comet-space">
      ...
      {/* Comet trail effect */}
      <div className="absolute top-1/4 left-0 w-full h-0.5 bg-comet-blue/30 blur-sm transform -rotate-12" />
      <div className="absolute top-3/4 right-0 w-full h-0.5 bg-comet-red/30 blur-sm transform rotate-12" />
      
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 hero-glow">
            Ready for Your <span className="text-comet-blue">CometCopters</span> Adventure?
          </h2>
          ...
          <div className="mt-12 relative max-w-md mx-auto">
            ...
            <div className="absolute bottom-0 left-0 w-full p-6 text-center">
              <span className="inline-block bg-comet-blue text-white px-4 py-2 rounded-full text-sm font-bold mb-2">
                Free Bonus!
              </span>
