      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 hero-glow">
            Ready for Your <span className="bg-gradient-to-r from-comet-pink via-comet-blue to-comet-green bg-clip-text text-transparent">CometCopters</span> Adventure?
          </h2>
