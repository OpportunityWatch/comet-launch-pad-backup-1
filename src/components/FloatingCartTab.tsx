...
const FloatingCartTab: React.FC<FloatingCartTabProps> = ({ onOpenCart }) => {
  ...
  return (
    ...
    >
      {/* Cart Tag - same width as Buy Now button but shorter */}
      <div className="relative mt-2">
        ...
        <div className="mt-4">
          <Button
            onClick={onOpenCart}
            className="bg-comet-blue hover:bg-comet-blue/80 text-white shadow-lg rounded-md h-8 px-8 border border-slate-300 relative flex items-center justify-center"
          >
